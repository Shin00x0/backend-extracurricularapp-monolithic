...
class UserProfileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'is_online', 'role', 'latitude', 'longitude', 'avatar'
        ]
...
class BaseUserSerializer(serializers.ModelSerializer):
    """Serializer for BaseUser model (authenticated user view)."""
    ...
    class Meta:
        ...
        fields = [
            ...
            'last_seen', 'role', 'avatar', 'firebase_profile', 'synced_at', 'created_at', 'updated_at'
        ]
        read_only_fields = ['id', 'firebase_uid', 'email', 'role', 'created_at', 'updated_at', 'firebase_profile', 'synced_at']
